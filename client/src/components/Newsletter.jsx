...
const Newsletter = () => {
  return (
    ...
    <div className='flex flex-col gap-2'>
        <h2 className='text-2xl text-center font-semibold'>Stay Inspired</h2>
        <p className='text-sm text-center'>Join our newsletter and be the first to discover new destinations, exclusive offers, and travel inspiration.</p>
    </div>
