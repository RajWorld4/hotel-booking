...
const AddRoom = () => {
  ...
  return (    
      <form>
       <div>
          <h1 className="text-3xl text-start">Add Room</h1>
          <p className="text-sm text-start">Fill in the details carefully and accurate room details, pricing, and amenities, to enhance the user booking experience.</p>
       </div>
       ...
       <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
        ...
        <div>
           ...
           <input type="number" placeholder="0" className="border border-gray-300 mt-1 rounded p-2 w-24" value={inputs.pricingPerNight} 
           onChange={(e)=>setInputs({...inputs, pricingPerNight: e.target.value})}/>
        </div>
       </div>
